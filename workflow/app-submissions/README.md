...
Use the [configuration tool and tutorial](../../README.md#8-connect-the-application) to replace the notebook's connection placeholders, schema guard, and experiment path before importing it. Create its job from the generated `app-job.json` and let the app supply a saved submission UUID.
