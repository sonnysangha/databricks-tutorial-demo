# PapaEats setup and technical reference

Follow the [main demo walkthrough](../README.md#follow-the-demo) for the video sequence. This reference supplies the installation commands and technical setup.
...
![PapaEats application workflow guide](images/app-workflow.png)
